...
(function (global, setTimeout) {
    var req, s, head, baseElement, dataMain, src,
        ...
        contexts = {},
        cfg = {},
        globalDefQueue = [],//ele:[name, deps, callback]
    ...
    function newContext(contextName) {
        ...
        function makeModuleMap(name, parentModuleMap, isNormalized, applyMap) {
            ...
            nameParts = splitPrefix(name); //Turns a plugin!resource to [plugin, resource]
            prefix = nameParts[0];
            name = nameParts[1];
        ...
        function checkLoaded() {
            ...
            eachProp(enabledRegistry, function (mod) {
                ...
                if (!map.isDefine) {// makeModuleMap中处理isDefine
                    reqCalls.push(mod);
                }
...
// 模块加载器
        ...
        context = {
            ...
            completeLoad: function (moduleName) {
                ...
                takeGlobalQueue();// 将globalDefqueue中的依赖放入defQueue
    ...
    req = requirejs = function (deps, callback, errback, optional) {
        ...
        if (!context) { //如果是第一次进入，调用newContext方法进行创建“_”上下文环境
